PdfBox-Android
==============
This project is based on and Forked from [PdfBox-Android by Tom Roush](https://github.com/tomroush/pdfbox-android)
...
```gradle
dependencies {
    implementation 'com.dineshdev:pdfbox-android:2.0.27.1'
}
```
